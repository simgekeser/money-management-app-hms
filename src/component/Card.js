...
async UNSAFE_componentWillMount() {    
    ...
    console.log('urii',this.props)
    this.setState({name:value,photoUri:photoUri});
}
                                ...
                                >
                                    <View style={styles.card}> 
                                     ...
                                     <View style={styles.card}>  
                                              ...
                                              <Text style={styles.cardMoneyTotalText}>{this.props.sumMonthly}</Text>
                                              <Ionicons name={'lira-sign'} size={15} color={'#6D1F4A'}/>
                                         </View>
                                     <View style={styles.card}>  
                                    ...
                                    <View style={styles.card}>  
                                            ...
                                            <Text style={styles.cardMoneyTotalText}>{this.props.sumYearly}</Text>
                                            <Ionicons name={'lira-sign'} size={15} color={'#6D1F4A'}/>
                                       </View>
                                </ScrollView>
