...
import { HMSNative,
 NativeMediaTypes,HMSInterstitial} from 'react-native-hms-ads';
...
export class DetailScreen extends Component {
    constructor(props) {
       ...
       // console.log('allData detail page',this.state.allData)
      }
                            ...
                            <View style={styles.inputStyle}>
                             ...
                             <View style={{justifyContent:'center'}}>
                                ...
                                <View style={{paddingTop:10,marginRight:50,marginLeft:50}}>
                                  <Button color="#ff5c5c" onPress={() => this._setData()} title="Add"/>
                                </View>
                              </View> 
                      </View>  
            </View>
