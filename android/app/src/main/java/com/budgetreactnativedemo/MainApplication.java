package com.budgetreactnativedemo;

import android.app.Application;
import android.content.Context;

import com.budgetreactnativedemo.rnhms.RNHMSPackage;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.budgetreactnativedemo.ReactNativeFlipper");
        aClass
